...
enum XMODEM_RECEIVE_STATES 
{ 
  XMODEM_RECEIVE_INITIAL,
  XMODEM_RECEIVE_SEND_C, 
  XMODEM_RECEIVE_WAIT_FOR_ACK,
  XMODEM_RECEIVE_TIMEOUT_ACK, 
  XMODEM_RECEIVE_READ_BLOCK_TIMEOUT,
  XMODEM_RECEIVE_ABORT_TRANSFER,
  XMODEM_RECEIVE_READ_BLOCK,
  XMODEM_RECEIVE_ACK_SUCCESS,
  XMODEM_RECEIVE_TRANSFER_COMPLETE,
  XMODEM_RECEIVE_READ_BLOCK_SUCCESS, 
